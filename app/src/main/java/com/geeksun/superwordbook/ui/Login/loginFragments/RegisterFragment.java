 ...
 */
public class RegisterFragment extends Fragment implements WelcomeFragment.OnFragmentInteractionListener{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        register_cancel = getActivity().findViewById(R.id.btn_register_cancel);
